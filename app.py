    ...
    for attempt in range(max_retries):
        try:
            ...
            payload_dict = {
                ...
                "GenerateType": "Normal",
                "FaceCount": 1000000,
                "ResultFormat": output_format.upper()  # ← STL/GLB напрямую
            }
                ...
                if "Response" in data:
                    ...
                    if status == "DONE":
                        ...
                        if result_files and "Url" in result_files[0]:
                            ...
                            print(f"Hunyuan: возвращаю {output_format.upper()}, размер: {len(model_data)} байт")
                ...
                if "Response" in data:
                    ...
                    if status == "DONE":
                        ...
                        if result_files and "Url" in result_files[0]:
                            ...
                            print(f"Hunyuan фото: возвращаю {output_format.upper()}, размер: {len(model_data)} байт")
                            return model_data, output_format
                    elif status == "FAIL":
                        raise Exception("Generation FAILED")

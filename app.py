...
def get_limit(user_id):
    ...
    if user_id not in user_limits or user_limits[user_id][0] != today:
        user_limits[user_id] = (today, 100)
        return 100
    return max(0, 100 - user_limits[user_id][1])
                ...
                for update in resp.json().get("result", []):
                    ...
                    if "callback_query" in update:
                        ...
                        if data == "menu":
                            ...
                            send_message(chat_id, "🎲 Выбран Meshy. Отправь фото или напиши промт:")
                        elif data == "gen_hunyuan":
                            user_states[chat_id] = ("hunyuan", None)
                            send_message(chat_id, "🔧 Выбран Hunyuan. Отправь фото или напиши промт:")
                        elif data == "my_models":
                        ...
                        if chat_id in user_states:
                            ...
                            # Обработка фото
                                ...
                                send_message(chat_id, "Пожалуйста, отправь текст или фото.")
                        else:

...
AI3D_HOST = "ai3d.intl.tencentcloudapi.com"  # для новых AI3D-операций (FBX-конвертация, Part)
AI3D_SERVICE = "ai3d"
...
def process_part_generation(chat_id, user_id, glb_url, gen_type, job_id=None, prompt=None, image_base64=None):
    ...
    ★ ИСПРАВЛЕНО ★:
    1. Convert3DFormat FBX → AI3D endpoint (ai3d.intl.tencentcloudapi.com)
       Старый Hunyuan endpoint возвращает FailedOperation.ServerError для FBX.

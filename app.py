        ...
        if status_response:
            ...
            if status == "SUCCEEDED":
                ...
                if model_url:
                    ...
                    if model_content:
                        send_document(chat_id, model_content, "3d_model.glb", "✅ Готово!")
                    else:
                ...
                for update in updates:
                    ...
                    if "callback_query" in update:
                        ...
                        if text == "/start":
                            ...
                            send_message(chat_id, "📖 Помощь: нажми кнопку 'Генерация 3D модели'")
                        else:
                            if user_data.get(chat_id, {}).get("awaiting_prompt"):
                                ...
                                send_message(chat_id, "Нажми кнопку '🎲 Генерация 3D модели'")
            time.sleep(1)
        except:
            time.sleep(5)

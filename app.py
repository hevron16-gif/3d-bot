...
TEXTS = {
    "ru": {
        ...
        "no_free": "❌ Бесплатные генерации закончились. Купите разовую (40⭐) или подписку (170⭐/мес).",
        "already_generating": "⏳ У вас уже выполняется генерация. Дождитесь завершения.",
        "rate_limit": "⏳ {msg}",
        "banned_words": "⚠️ Ваш запрос содержит запрещённые слова. Пожалуйста, измените описание.",
        ...
        "thanks_message": "📨 Спасибо за сообщение! Я передал его разработчику. Обычно он отвечает в течение нескольких часов.",
        ...
        "grant_sub_ok": "✅ Подписка на месяц активирована для пользователя {uid}",
        "grant_sub_fail": "❌ Использование: /grant_sub <user_id>",
        "grant_sub_user": "✅ Ваша подписка активирована администратором вручную. Приятного пользования!",
        ...
        "ask_ai": "💬 *Спросить AI*\n\nЗадайте любой вопрос нейросети DeepSeek V4 Pro.\n\nНапример:\n«Придумай 5 идей для 3D-моделей»\n«Напиши сценарий для игры»\n«Объясни, как работает 3D-печать»",
        "ai_thinking": "⏳ DeepSeek думает...",
        "ai_answer": "💬 *Ответ DeepSeek V4 Pro:*\n\n{answer}",
    },
    "en": {
        ...
        "no_free": "❌ Free generations exhausted. Buy one-time (40⭐) or subscription (170⭐/month).",
        "already_generating": "⏳ You already have a generation in progress. Wait for completion.",
        "rate_limit": "⏳ {msg}",
        "banned_words": "⚠️ Your request contains prohibited words. Please change the description.",
        ...
        "thanks_message": "📨 Thank you for your message! I forwarded it to the developer. Usually he replies within a few hours.",
        ...
        "choose_lang": "🌐 Выберите язык / Choose language:",
        "grant_sub_ok": "✅ Monthly subscription activated for user {uid}",
        "grant_sub_fail": "❌ Usage: /grant_sub <user_id>",
        "grant_sub_user": "✅ Your subscription has been manually activated by the admin. Enjoy!",
        "refine_prompt": "📝 Your last prompt: *{prompt}*\n\nDescribe what to change:",
        "no_last_prompt": "⚠️ No last prompt. Generate a model first.",
        "ask_ai": "💬 *Ask AI*\n\nAsk any question to DeepSeek V4 Pro neural network.\n\nFor example:\n«Come up with 5 ideas for 3D models»\n«Write a game scenario»\n«Explain how 3D printing works»",
        "ai_thinking": "⏳ DeepSeek is thinking...",
        "ai_answer": "💬 *DeepSeek V4 Pro answer:*\n\n{answer}",
    }
}

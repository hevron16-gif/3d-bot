...
TEXTS = {
    ...
    "en": {
        ...
        "part_split_done": "✅ Split complete! {count} parts.\n\n💡 To add connectors (pin-socket, clips, snaps) use Blender, Tinkercad or Fusion 360.",
...
def hunyuan_generate_from_drawings(prompt, image_base64=None, max_retries=3, user_id=None):
...
def hunyuan_regenerate_for_part(prompt=None, image_base64=None, max_retries=2):
    ...
    try:
        ...
        if not fbx_url:
            ...
            if prompt or img:
                ...
                fbx_url = hunyuan_regenerate_for_part(prompt=prompt, image_base64=img)
                if fbx_url:
